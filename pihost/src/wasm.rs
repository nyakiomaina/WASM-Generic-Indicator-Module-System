...
pub const SENSOR_BATTERY: u32 = 20;
...
impl From<InterpretorError> for Error {
...
impl Runtime {
    #[cfg(any(target_arch = "armv7", target_arch = "arm"))]
    pub fn new() -> Runtime {
        println!("Initiating WASM runtime (ARM)...");
        Runtime {
...
impl<'a> ModuleImportResolver for RuntimeModuleImportResolver {
    fn resolve_func(
        ...
        println!("Resolving import: {}", field_name);
        let func_ref = match field_name {
            ...
            _ => {
                return Err(InterpreterError::Runction(format!(
